...
public abstract class BaseProcessor implements Processor {
    ...
    public synchronized void init(ProcessingEnvironment env){
        ...
        modName = "heavyindustry";

        packageName = "heavyindustry.gen";

        packageFetch = "heavyindustry.fetched";
    ...
    private static <T extends Annotation> T createAnno(Element e, Class<T> type){
        Attribute.Compound compound = Reflect.invoke(AnnoConstruct.class, e, "getAttribute", new Object[]{type}, Class.class);
        return compound == null ? null : AnnotationProxyMaker.generate(compound, type);
    }
