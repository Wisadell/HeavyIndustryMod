...
import ent.annotations.*;
import ent.annotations.Annotations.*;
import mindustry.*;
...
public class EntityIO{
    ...
    public final TypeIOResolver.ClassSerializer serializer;
    ...
    public EntityIO(BaseProcessor proc, String name, TypeSpec.Builder type, Seq<FieldSpec> typeFields, TypeIOResolver.ClassSerializer serializer, Fi directory){
        this.proc = proc;
    ...
    public void writeSync(MethodSpec.Builder method, boolean write, Seq<VarSymbol> allFields){
        ...
        if(write){
            ...
            for(var field : rev.fields){
                ...
                boolean sf = BaseProcessor.anno(var, SyncField.class) != null, sl = BaseProcessor.anno(var, SyncLocal.class) != null;
