    ...
    protected void process() throws IOException{
        switch(round){
            case 1 -> {
                ...
                pointer:
                for(var t : this.<ClassSymbol>with(Point.class)){
            ...
            case 2 -> {
                ...
                for(var def : defs){
                    ...
                    for(var entry : methods.entries()){
                        ...
                        if(hasIO){
                            if(io == null) io = new EntityIO(this, name, builder, allFieldSpecs, serializer, rootDirectory.child(name));
