...
import HeavyIndustry.world.drawer.DrawHighEnergyNode;
...
public class HighEnergyNode extends ItemBridge {
    public DrawBlock drawer = new DrawMulti(new DrawDefault(), new DrawHighEnergyNode());
    ...
    public boolean linkValid(Tile tile, Tile other, boolean checkDouble) {
        ...
        return ((other.block() == tile.block() && tile.block() == this) || (!(tile.block() instanceof HighEnergyNode) && other.block() == this))
                && (other.team() == tile.team() || tile.block() != this)
                && (!checkDouble || ((HighEnergyNodeBuild)other.build).link != tile.pos());
    }
    ...
    public class HighEnergyNodeBuild extends ItemBridgeBuild{
        @Override
