...
public class FloatPlatformDrawer {
    ...
    public static void load(){
        ...
        center = Core.atlas.find(name("platform-center"));
        for(int i = 0; i < 4; i++){
            edgeA[i] = Core.atlas.find(name("platform-A-" + i));
            edgeB[i] = Core.atlas.find(name("platform-B-" + i));
            corner[i] = Core.atlas.find(name("platform-corner-" + i));
        }
    }
