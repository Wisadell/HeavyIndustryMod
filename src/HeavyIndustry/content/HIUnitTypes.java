...
import HeavyIndustry.world.entity.bullet.ScarletDevilBulletType;
...
public class HIUnitTypes {
    ...
    public static void load(){
        ...
        suzerain = new UnitType("suzerain"){{
            ...
            weapons.add(
                    new Weapon(name("suzerain-weapon")){{
                        ...
                        bullet = new BasicBulletType(15f, 160){{
                            pierceArmor = true;
                            pierce = true;
                            pierceCap = 10;
                            width = 14f;
                            ...
                            fragBullet = new BasicBulletType(9f, 55){{
                                width = 10f;
                                height = 10f;
                                pierceArmor = true;
                                pierce = true;
        ...
        supernova = new UnitType("supernova"){{
            ...
            drawShields = false;
            abilities.add(
                    new EnergyFieldAbility(60, 90, 200){{
                        maxTargets = 25;
                        healPercent = 6;
                        hitUnits = false;
                        y = -20;
            ...
            weapons.add(
                    new Weapon(name("supernova-weapon")){{
                        mirror = false;
                        top = false;
                        y = 0f;
                        x = 0f;
        ...
        harpoon = new UnitType("harpoon"){{
            ...
            weapons.addAll(
                    new Weapon(name("harpoon-main")){{
                        ...
                        shake = 12f;
                        bullet = new BasicBulletType(14, 960){{
                            scaleLife = true;
                            ...
                            hitEffect = new MultiEffect(
                                    new ParticleEffect(){{
                                        ...
                                        colorFrom = Color.white;
                                        colorTo = Color.valueOf("feebb380");
                                    }},
                                    new WaveEffect(){{
                                        lifetime = 80f;
                                        ...
                                        strokeFrom = 10f;
                                        strokeTo = 0f;
                                        colorFrom = colorTo = HIPal.breakdownYellow;
                                    }},
                                    new WaveEffect(){{
                                        lifetime = 10f;
                                        sizeFrom = 5f;
                            ...
                            width = 22f;
                            height = 45f;
                            frontColor = backColor = trailColor = HIPal.breakdownYellow;
                            trailLength = 15;
                            trailWidth = 3;
                            lifetime = 60f;
                            splashDamageRadius = 77f;
                            splashDamage = 390;
                            lightningDamage = 180;
                            lightning = 3;
                            lightningLength = 12;
                            ...
                            fragLifeMin = 1;
                            fragVelocityMin = 1f;
                            fragBullet = new BasicBulletType(4, 270){{
                                ...
                                intervalBullets = 2;
                                intervalDelay = 1;
                                intervalBullet = new BasicBulletType(2, 77){{
        ...
        killerWhale = new UnitType("killer-whale"){{
            ...
            weapons.addAll(
                    new Weapon(name("killer-whale-weapons")){{
                        rotate = true;
                        x = 18f;
                        y = 7f;
                        reload = 65f;
        ...
        dominate = new TankUnitType("dominate"){{
            ...
            weapons.add(
                    new Weapon(name("dominate-weapon")){{
                        mirror = false;
                        rotate = true;
                        layerOffset = 0.1f;
                        rotateSpeed = 0.9f;
                        ...
                        bullet = new ScarletDevilBulletType(Color.valueOf("feb380")){{
        ...
        havoc = new ErekirUnitType("havoc"){{
            ...
            weapons.add(new Weapon("disrupt-weapon"){{
                ...
                bullet = new BulletType(){{
                    ...
                    speed = 0f;
                    keepVelocity = false;
                    spawnUnit = new MissileUnitType("havoc-missile"){{
                        speed = 5.8f;
                        maxRange = 6f;
                        ...
                        weapons.add(new Weapon(){{
                            ...
                            reload = 1f;
                            shootOnDeath = true;
                            bullet = new ExplosionBulletType(220f, 30f){{
