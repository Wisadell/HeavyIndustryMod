...
public class HITechTree {
    ...
    public static void load(){
        ...
        //liquid
        addToNode(impulsePump, () -> node(rapidPump));
        ...
        //power
        addToNode(combustionGenerator, () -> node(tidalGenerator));
        ...
        addToNode(pulverizer, () -> node(largePulverizer, () -> {
            node(uraniumSynthesizer, Seq.with(new SectorComplete(desolateRift)), () -> {});
            node(chromiumSynthesizer, Seq.with(new SectorComplete(desolateRift)), () -> {});
        }));
        ...
        addToNode(unloader, () -> node(rapidUnloader, () -> node(highEnergyDirectionalUnloader)));
        //unit
        ...
        addToNode(salvo, () -> node(rend, () -> node(fissure)));
        addToNode(cyclone, () -> node(splitPlum));
        addToNode(spectre, () -> node(minigun));
        addToNode(meltdown, () -> {
