...
import HeavyIndustry.world.game.HIPartProgress;
...
public class HIBlocks {
    public static Block
            ...
            stoneVent,basaltVent,basaltWall,basaltGraphiteWall,snowySand,snowySandWall,arkyciteSand,arkyciteSandWall,arkyciteSandBoulder,darksandBoulder,tundra,tundraWall,
            stoneWater,shaleWater,basaltWater,frozenWater,aghatiteWater,greniteWater,darkGreniteWater,albasterWater,quartzSandWater,
            deadGrass,frozenSoil,albaster,albasterTiles,albasterCrater,aghatite,aghatitePebbles,quartzSand,grenite,darkGrenite,malachite,coastalGrenite,blueIce,blueIcePieces,blueSnow,blueSnowdrifts,
            deadThickets,frozenSoilWall,albasterWall,aghatiteWall,quartzSandWall,greniteWall,darkGreniteWall,malachiteWall,blueIceWall,blueSnowWall,
            deadShrub,frozenSoilBoulder,albasterBoulder,aghatiteBoulder, quartzSandBoulder, greniteBoulder,darkGreniteBoulder,darkGreniteBlocks,blueBoulder,
            malachiteTree,
            ...
            //liquid
            rapidPump,highEnergyLiquidNode,chromiumArmorConduit,chromiumLiquidBridge,chromiumArmorLiquidTank,
            //liquid-erekir
            liquidSorter,liquidValve,smallReinforcedPump,largeReinforcedPump,
            //power
            tidalGenerator,powerNodeHighEnergy,powerNodeGiant,uraniumReactor,armoredCoatedBattery,
            //power-erekir
            ...
            rend,fissure,splitPlum,
            frost,concentration,thermoelectricIon,fiammetta,wisadel,spark,fireworks,
            //turret-erekir
            tracer,shadow;
    public static void load(){
        ...
        stoneWater = new Floor("stone-water", 0){{
            ...
            attributes.set(HIAttribute.tide, 0.5f);
        }};
        shaleWater = new Floor("shale-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        basaltWater = new Floor("basalt-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        frozenWater = new Floor("frozen-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        aghatiteWater = new Floor("aghatite-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        greniteWater = new Floor("grenite-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        darkGreniteWater = new Floor("dark-grenite-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        albasterWater = new Floor("albaster-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        quartzSandWater = new Floor("quartz-sand-water", 0){{
            speedMultiplier = 0.6f;
            liquidDrop = Liquids.water;
            isLiquid = true;
            cacheLayer = CacheLayer.water;
        ...
        darkGrenite = new Floor("dark-grenite", 3){{
            wall = darkGreniteWall;
        }};
        darkGreniteWall = new StaticWall("dark-grenite-wall"){{
            variants = 5;
            attributes.set(Attribute.sand, 1f);
        }};
        darkGreniteBoulder = new Prop("dark-grenite-boulder"){{
            variants = 2;
            darkGrenite.asFloor().decoration = this;
        }};
        darkGreniteBlocks = new TallBlock("dark-grenite-blocks"){{
            variants = 2;
        }};
        malachite = new Floor("malachite", 3);
        ...
        malachiteTree = new TreeBlock("malachite-tree");
        ...
        nanoCompositeWall = new RegenWall("nano-composite-wall"){{
            requirements(Category.defense, with(HIItems.nanocore, 2, HIItems.heavyAlloy, 6, Items.metaglass, 3, Items.plastanium, 4));
            size = 1;
            health = 2240;
            armor = 42;
            absorbLasers = insulated = true;
        ...
        nanoCompositeWallLarge = new RegenWall("nano-composite-wall-large"){{
            requirements(Category.defense, with(HIItems.nanocore, 8, HIItems.heavyAlloy, 24, Items.metaglass, 12, Items.plastanium, 16));
            size = 2;
            health = 8960;
            armor = 42;
            absorbLasers = insulated = true;
        ...
        reinforcedDrill = new Drill("reinforced-drill"){{
            requirements(Category.production, with(Items.graphite, 100, Items.silicon, 120, Items.thorium, 50, Items.plastanium, 40, Items.surgeAlloy, 15));
            size = 3;
            health = 590;
            armor = 3;
            hasPower = true;
        ...
        //power
        tidalGenerator = new ThermalGenerator("tidal-generator"){{
            requirements(Category.power, ItemStack.with(Items.titanium, 60, Items.graphite, 50, Items.metaglass, 40, Items.silicon, 30));
            size = 2;
            powerProduction = 1.5f;
            floating = true;
            attribute = HIAttribute.tide;
        }};
        ...
        nanocorePrinter = new GenericCrafter("nanocore-printer"){{
            ...
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawScanLine(){{
                ...
                phaseOffset = Mathf.random() * 5f;
            }}, new DrawRegion("-mid"), new DrawLiquidTile(Liquids.cryofluid), new DrawDefault(), new DrawGlowRegion("-glow1"){{
                alpha = 1f;
        ...
        heavyAlloySmelter = new GenericCrafter("heavy-alloy-smelter"){{
            requirements(Category.crafting, with(Items.lead, 80, Items.graphite, 120, Items.silicon, 60, HIItems.highEnergyFabric, 10, HIItems.chromium, 30));
            size = 3;
            health = 850;
            craftTime = 100f;
        ...
        titanReconstructor = new Reconstructor("titan-reconstructor"){{
            ...
            consumeItems(ItemStack.with(Items.silicon, 1200, HIItems.highEnergyFabric, 100, HIItems.uranium, 200, HIItems.chromium, 300));
        }};
        ...
        rend = new ItemTurret("rend"){{
            requirements(Category.turret, with(Items.copper, 30, Items.lead, 60, Items.graphite, 40));
            health = 960;
            range = 200;
            smokeEffect = Fx.shootBigSmoke;
        ...
        fissure = new ItemTurret("fissure"){{
            ...
            ammo(Items.titanium, new BasicBulletType(8f, 45f){{
                ...
                hitEffect = HIFx.hitSparkLarge;
                ammoMultiplier = 4;
            }},HIItems.chromium, new BasicBulletType(8f, 105f){{
                lifetime = 48f;
                width = 8f;
                height = 42f;
                shrinkX = 0;
        ...
        splitPlum = new ShootMatchTurret("split-plum"){{
            requirements(Category.turret, with(Items.graphite, 180, Items.silicon, 360, Items.surgeAlloy, 120, Items.phaseFabric, 80));
            ammo(Items.phaseFabric, new TrailFadeBulletType(4f, 580f, "circle-bullet"){{
                velocityBegin = 8.8f;
                ...
                lifetime = 92f;
                backColor = lightColor = lightningColor = trailColor = hitColor = HIPal.ancient;
                ...
                shootEffect = new EffectWrapper(HIFx.shootLine(30f, 120f), backColor);
                hitEffect = HIFx.square45_6_45;
            ...
            }, Items.surgeAlloy, new AccelBulletType(2.85f, 280f){{
                frontColor = HIPal.ancientLight;
                backColor = lightningColor = trailColor = hitColor = lightColor = HIPal.ancient;
                lifetime = 92f;
                knockback = 2f;
                ammoMultiplier = 6f;
                accelerateBegin = 0.1f;
                ...
                hitEffect = HIFx.hitSparkLarge;
                despawnEffect = HIFx.square45_6_45;
                shootEffect = new EffectWrapper(HIFx.shootLine(22, 20f), backColor);
                smokeEffect = HIFx.hugeSmokeGray;
            ...
            shooter(Items.phaseFabric, new ShootSpread(){{
                shots = 15;
                spread = 8;
            }}, Items.surgeAlloy, new ShootAlternate(){{
                shots = 3;
                shotDelay = 5;
                spread = 11f;
            }});
            ...
            reload = 60.0F;
            rotateSpeed = 2.4f;
            shootSound = HISounds.flak2;
            shootCone = 35f;
            ammoPerShot = 6;
            maxAmmo = 30;
            cooldownTime = 65f;
            squareSprite = false;
            drawer = new DrawTurret("reinforced-"){{parts.add(new RegionPart("-top"){{
                layerOffset = 0.1f;
                heatLayerOffset = 0;
            }}, new RegionPart("-back"){{
                mirror = true;
                ...
                progress = HIPartProgress.recoilWarmup;
                heatLayerOffset = 0;
            }});
            }};
            ...
            canOverdrive = false;
            coolant = consumeCoolant(15f / 60f);
            coolantMultiplier = 2f;
        ...
        concentration = new ContinuousTurret("concentration"){{
            requirements(Category.turret, with(Items.silicon, 800, Items.metaglass, 400, Items.surgeAlloy, 600, HIItems.highEnergyFabric, 350, HIItems.heavyAlloy, 250));
            shootType = new PointLaserBulletType(){{
                ...
                private final Color from = color, to = HIPal.darkEnrColor;
        ...
        fiammetta = new ItemTurret("fiammetta"){{
            ...
            ammo(
                    ...
                    Items.phaseFabric, new BulletType(15f, 300){{
        ...
        wisadel = new ItemTurret("wisadel"){{
            requirements(Category.turret, with(Items.silicon, 1500, Items.plastanium, 1200, Items.surgeAlloy, 800, HIItems.highEnergyFabric, 400, HIItems.heavyAlloy, 600));
            ammo(
                    HIItems.uranium, new TrailFadeBulletType(35f, 5650f, "missile-large"){{
                        ammoMultiplier = 1f;
                        shootEffect = Fx.none;
                        smokeEffect = Fx.none;
                        width = 16f;
                        ...
                        lifetime = 28f;
                        frontColor = lightningColor = hitColor = backColor = trailColor = lightColor = HIPal.uraniumGrey;
                        lightning = 6;
                        lightningLength = 12;
                        ...
                        hitEffect = HIFx.instHit(lightningColor);
                        hitSound = despawnSound = Sounds.shotgun;
                        hitShake = 3f;
                        chargeEffect = new MultiEffect(HIFx.genericCharge(backColor,18, 120, 90), EffectWrapper.wrap(HIFx.square45_6_45_Charge, backColor));
                        ...
                        despawnEffect = new MultiEffect(HIFx.instBomb(lightningColor), HIFx.sharpBlast(backColor, frontColor, 50f, 90f));
                        ...
                        intervalBullet = new AdaptedLightningBulletType(){{
                            lightningColor = trailColor = hitColor = lightColor = HIPal.uraniumGrey;
                            lightningLength = 4;
                            lightningLengthRand = 15;
                            damage = 200;
                        }};
                    }},
                    HIItems.highEnergyFabric, new TrailFadeBulletType(22f, 550f, "missile-large"){{
