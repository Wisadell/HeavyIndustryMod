...
import static mindustry.content.Fx.artilleryTrail;
...
public class HIBlocks {
    public static Block
            ...
            stoneVent,basaltVent,basaltWall,snowySand,snowySandWall,arkyciteSand,arkyciteSandWall,arkyciteSandBoulder,darksandBoulder,tundra,tundraWall,
            greniteWatee,
            deadGrass,frozenSoil,albaster,albasterTiles,albasterCrater,aghatite,aghatitePebbles,quartzSand,grenite,darkGrenite,coastalGrenite,blueIce,blueIcePieces,blueSnow,blueSnowdrifts,
            ...
            //power
            powerNodeHighEnergy,powerNodeGiant,uraniumReactor,armoredCoatedBattery,
            //power-erekir
            ...
            frost,thermoelectricIon,fiammetta,wisadel,spark,fireworks,
            //turret-erekir
            tracer,shadow;
            //sandbox
    public static void load(){
        ...
        greniteWatee = new Floor("grenite-water", 0){{
        ...
        fiammetta = new ItemTurret("fiammetta"){{
            ...
            ammo(
                    ...
                    HIItems.highEnergyFabric, new BulletType(15f, 300){{
        ...
        wisadel = new ItemTurret("wisadel"){{
            ...
            ammo(
                    Items.blastCompound, new BasicBulletType(18f, 1800f){{
                        ammoMultiplier = 1f;
                        sprite = name("missile");
                        shootEffect = Fx.none;
                        smokeEffect = Fx.none;
                        ...
                        public void update(Bullet b) {
                            ...
                            artilleryTrail.at(x1, y1, 3, HIPal.wisadelRed);
                            artilleryTrail.at(x2, y2, 3, HIPal.wisadelRed);
                            if(b.timer.get(2, lifetime / 4)){
                                HIFx.ellipse(40, 8, 16 / 2, 40, HIPal.wisadelRed).at(b.x, b.y, b.rotation());
                            }
                        }
                    }
            );
            ...
            armor = 36;
            health = 13200;
            drawer = new DrawMulti(new DrawTurret("reinforced-"){{parts.addAll(new RegionPart("-behind"){{
