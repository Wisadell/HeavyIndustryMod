...
public class HIBlocks {
    public static Block
            ...
            //liquid
            turboPump,highEnergyLiquidNode,chromiumArmorConduit,chromiumLiquidBridge,chromiumArmorLiquidTank,
            //liquid-erekir
    ...
    public static void load(){
        ...
        wisadel = new ItemTurret("wisadel"){{
            ...
            ammo(HIItems.highEnergyFabric, new TrailFadeBulletType(32f, 550f, "missile-large"){{
                ammoMultiplier = 1f;
                shootEffect = smokeEffect = Fx.none;
                width = 16f;
                height = 50f;
