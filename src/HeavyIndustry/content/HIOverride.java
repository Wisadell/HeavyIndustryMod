...
public class HIOverride {
    public static void load(){
        //Blocks-Environment
        Blocks.water.attributes.set(HIAttribute.tide, 1f);
        Blocks.deepwater.attributes.set(HIAttribute.tide, 1.5f);
        ...
        Blocks.sandWater.attributes.set(HIAttribute.tide, 0.5f);
        Blocks.darksandWater.attributes.set(HIAttribute.tide, 0.5f);
        Blocks.darksandTaintedWater.attributes.set(HIAttribute.tide, 0.5f);
        Blocks.taintedWater.attributes.set(HIAttribute.tide, 1f);
        Blocks.deepTaintedWater.attributes.set(HIAttribute.tide, 1.5f);
        ...
        Liquids.hydrogen.explosiveness = 1f;
