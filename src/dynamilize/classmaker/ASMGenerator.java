 ...
 * <br><i>There is an unresolved performance issue with this class, which is the optimization of partially stackable local variables.</i>
 */
...
public class ASMGenerator extends AbstractClassGenerator implements Opcodes {
    ...
    public void visitInvoke(IInvoke<?> invoke) {
        ...
        if (!Modifier.isStatic(invoke.method().modifiers())) {
            if (!(invoke.target() instanceof StackElem)) {
                methodVisitor.visitVarInsn(Opcodes.ALOAD, localIndex.get(invoke.target().name()));
            }
        }

        if (!invoke.args().isEmpty() && !(invoke.args().get(0) instanceof StackElem)) {
        ...
        if (invoke.returnTo() == null) {
            ...
            if (invoke.returnTo() instanceof StackElem) return;
            methodVisitor.visitVarInsn(
    ...
    public void visitGetField(IGetField<?, ?> getField) {
        if (!Modifier.isStatic(getField.source().modifiers())) {
            if (!(getField.inst() instanceof StackElem)) {
        ...
        if (!(getField.target() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitPutField(IPutField<?, ?> putField) {
        if (!Modifier.isStatic(putField.target().modifiers())) {
            if (!(putField.inst() instanceof StackElem)) {
                methodVisitor.visitVarInsn(Opcodes.ALOAD, localIndex.get(putField.inst().name()));
            }
        }

        if (!(putField.source() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitLocalSet(ILocalAssign<?, ?> localSet) {
        if (!(localSet.source() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
                    getLoadType(localSet.source().type()),
                    localIndex.get(localSet.source().name())
            );
        } else if (localSet.target() instanceof StackElem) {
            methodVisitor.visitInsn(Opcodes.DUP);
            return;
        }

        castAssign(localSet.source().type(), localSet.target().type());
        if (localSet.target() instanceof StackElem) return;
    ...
    public void visitOperate(IOperate<?> operate) {
        if (!(operate.leftOpNumber() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
        ...
        if (!(operate.rightOpNumber() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
        ...
        if (operate.resultTo() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitCast(ICast cast) {
        if (!(cast.source() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
        ...
        if (cast.target() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitCompare(ICompare<?> compare) {
        ...
        if (!(compare.leftNumber() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
        ...
        if (!(compare.rightNumber() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitCondition(ICondition condition) {
        ...
        if (!(condition.condition() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitArrayGet(IArrayGet<?> arrayGet) {
        if (!(arrayGet.array() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
                    Opcodes.ALOAD,
        ...
        int loadType = getAnInt(componentType);

        if (!(arrayGet.index() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
                    Opcodes.ILOAD,
        ...
        if (arrayGet.getTo() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitArrayPut(IArrayPut<?> arrayPut) {
        if (!(arrayPut.array() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
                    Opcodes.ALOAD,
        ...
        if (!(arrayPut.index() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
                    Opcodes.ILOAD,
        ...
        int storeType = getType(componentType);

        if (!(arrayPut.value() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    private static int getAnInt(IClass<?> componentType) {
        int loadType;
    ...
    private static int getType(IClass<?> componentType) {
        int storeType;
    ...
    public void visitSwitch(ISwitch<?> zwitch) {
        if (!(zwitch.target() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitThrow(IThrow<?> thr) {
        if (!(thr.thr() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitReturn(IReturn<?> iReturn) {
        if (iReturn.returnValue() == null) {
            ...
            if (!(iReturn.returnValue() instanceof StackElem)) {
                methodVisitor.visitVarInsn(
                        getLoadType(retType),
    ...
    public void visitInstanceOf(IInstanceOf instanceOf) {
        if (!(instanceOf.target() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
        ...
        if (instanceOf.result() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitNewInstance(INewInstance<?> newInstance) {
        ...
        if (!newInstance.params().isEmpty() && !(newInstance.params().get(0) instanceof StackElem)) {
        ...
        if (newInstance.instanceTo() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitOddOperate(IOddOperate<?> operate) {
        if (!(operate.operateNumber() instanceof StackElem)) {
            methodVisitor.visitVarInsn(
    ...
    public void visitConstant(ILoadConstant<?> loadConstant) {
        ...
        if (loadConstant.constTo() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
    ...
    public void visitNewArray(INewArray<?> newArray) {
        ...
        if (dimension == 1) {
            ...
            if (!(newArray.arrayLength().get(0) instanceof StackElem)) {
        ...
        if (newArray.resultTo() instanceof StackElem) return;
        methodVisitor.visitVarInsn(
                Opcodes.ASTORE,
    ...
    protected void wrapAssign(IClass<?> source) {
        ...
        if (source == ClassInfo.INT_TYPE) {
            typeDisc = "java/lang/Integer";
            methodDisc = "(I)Ljava/lang/Integer;";
        } else if (source == ClassInfo.FLOAT_TYPE) {
            typeDisc = "java/lang/Float";
            methodDisc = "(F)Ljava/lang/Float;";
        } else if (source == ClassInfo.LONG_TYPE) {
            typeDisc = "java/lang/Long";
            methodDisc = "(J)Ljava/lang/Long;";
        } else if (source == ClassInfo.DOUBLE_TYPE) {
            typeDisc = "java/lang/Double";
            methodDisc = "(D)Ljava/lang/Double;";
        } else if (source == ClassInfo.BYTE_TYPE) {
            typeDisc = "java/lang/Byte";
            methodDisc = "(B)Ljava/lang/Byte;";
        } else if (source == ClassInfo.SHORT_TYPE) {
            typeDisc = "java/lang/Short";
            methodDisc = "(S)Ljava/lang/Short;";
        } else if (source == ClassInfo.BOOLEAN_TYPE) {
            typeDisc = "java/lang/Boolean";
            methodDisc = "(Z)Ljava/lang/Boolean;";
        } else if (source == ClassInfo.CHAR_TYPE) {
            typeDisc = "java/lang/Character";
            methodDisc = "(C)Ljava/lang/Character;";
        }
