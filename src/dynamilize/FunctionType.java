...
/**
 * Function type encapsulates objects,
 * recording the parameter types of functions for comparison and search.
 */
public class FunctionType {
    /**
     * Reuse the recycling area capacity, changing the value usually does not require setting,
     * but if you may need large-scale recursion or a large number of concurrent calls,
     * you may need to set this limit to a higher value.
     */
    ...
    /**
     * This type of data has frequent calls, small data volume,
     * and unnecessary performance costs when using stream processing.
     * Using for traversal instead of stream processing.
     */
