...
public final class HIReflect {
    ...
    public static Seq<Consume> getBlockConsumeBuilder(Block block) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        return (Seq<Consume>)getBlockField(block, "consumeBuilder").get(block);
    }

    public static <T extends Block> Field getBlockField(T block, String typeField) throws ClassNotFoundException, NoSuchFieldException {
        return getField(block, "mindustry.world.Block", typeField);
    }

    public static <T> Field getField(T object, String typeName, String typeField) throws ClassNotFoundException, NoSuchFieldException {
