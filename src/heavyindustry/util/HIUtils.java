...
public final class HIUtils {
    ...
    /**
     * Storage classes for some empty collections, usually used when there is a need to reference empty collections, such as the getDefault and default initialization usage of maps, etc.
