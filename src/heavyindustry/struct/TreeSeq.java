...
/**
 * An ordered and reconfigurable set based on {@link TreeSet}, adding elements to this set will insert them into positions of appropriate size. According to the comparator, the elements in this set must be ordered.
 * <p>Different from {@link TreeSet}, this set allows multiple comparators to consider objects as equal.
 * <p>The insertion complexity is usually o (logn), but if the values compared by the comparator are concentrated on this set may degrade to o (n). When traversing this set, the elements obtained are ordered.
 */
