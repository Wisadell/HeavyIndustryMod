...
public class HILegsPayloadUnit extends Unit implements Boundedc, Builderc, Drawc, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Legsc, Minerc, Payloadc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
    ...
    @Override
    public int classId() {
        return EntityRegistry.getID(HILegsPayloadUnit.class);
    }
    ...
    public static HILegsPayloadUnit create() {
        return new HILegsPayloadUnit();
    }
