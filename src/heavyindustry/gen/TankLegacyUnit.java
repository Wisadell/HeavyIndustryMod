...
public class TankLegacyUnit extends Unit implements Boundedc, Builderc, Drawc, ElevationMovec, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Tankc, Teamc, Unitc, Velc, Weaponsc {
    ...
    @Override
    public int classId() {
        return EntityRegistry.getID(TankLegacyUnit.class);
    }
    ...
    public static TankLegacyUnit create() {
        return new TankLegacyUnit();
    }
