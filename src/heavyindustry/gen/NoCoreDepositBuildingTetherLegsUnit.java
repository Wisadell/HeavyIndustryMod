...
public class NoCoreDepositBuildingTetherLegsUnit extends Unit implements Boundedc, Builderc, BuildingTetherc, Drawc, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Legsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc, NoCoreDepositc {
    ...
    @Override
    public int classId() {
        return EntityRegistry.getID(NoCoreDepositBuildingTetherLegsUnit.class);
    }
    ...
    public void read(Reads read) {
        ...
        switch(REV) {
            ...
            default -> {
                throw new IllegalArgumentException("Unknown revision '" + REV + "' for entities type 'NoCoreDepositBuildingTetherLegsUnit'");
            }
        }
        afterRead();
    }
    ...
    public static NoCoreDepositBuildingTetherLegsUnit create() {
        return new NoCoreDepositBuildingTetherLegsUnit();
    }
}
