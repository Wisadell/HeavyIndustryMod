        ...
        public void draw() {
            ...
            for(int i = 0; i < 4; i++){
                if((blending & (1 << i)) != 0){
                    ...
                    Draw.rect(sliced(conveyorParts[0][frame], i != 0 ? SliceMode.bottom : SliceMode.top), x + Geometry.d4x(dir) * tilesize * 0.75f, y + Geometry.d4y(dir) * tilesize * 0.75f, rot);
            ...
            Draw.rect(conveyorParts[blendbits][frame], x, y, tilesize * blendsclx, tilesize * blendscly, rotation * 90);
