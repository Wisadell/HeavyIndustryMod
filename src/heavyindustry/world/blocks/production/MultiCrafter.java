...
public class MultiCrafter extends Block {
    ...
    public MultiCrafter(String name) {
        ...
        consume(new ConsumeItemDynamicF((MultiCrafterBuild tile) -> tile.currentRecipeIndex != -1 ? recipeSeq.get(Math.min(tile.currentRecipeIndex, recipeSeq.size - 1)).inputItems : null));
        consume(new ConsumeLiquidDynamicF((MultiCrafterBuild tile) -> tile.currentRecipeIndex != -1 ? recipeSeq.get(Math.min(tile.currentRecipeIndex, recipeSeq.size - 1)).inputLiquids : null));
        consume(new ConsumePowerDynamic(usage -> usage instanceof MultiCrafterBuild tile ? tile.getInputPower() : 0f));

        consume(new ConsumeShowStat((MultiCrafterBuild tile) -> tile.currentRecipeIndex != -1 ? recipeSeq.get(Math.min(tile.currentRecipeIndex, recipeSeq.size - 1)).inputItems : null, (MultiCrafterBuild tile) -> tile.currentRecipeIndex != -1 ? recipeSeq.get(Math.min(tile.currentRecipeIndex, recipeSeq.size - 1)).inputLiquids : null));
