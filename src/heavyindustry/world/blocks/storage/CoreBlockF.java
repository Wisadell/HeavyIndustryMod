...
public class CoreBlockF extends CoreBlock {
    public float spawnCooldown = 2f * 60f;

    public CoreBlockF(String name) {
        super(name);
    }

    public class CoreBuildF extends CoreBuild {
        public float timer = 0f;
        public boolean requested = false;
        public float heat, progress, time;

        public @Nullable Player spawnPlayer;
