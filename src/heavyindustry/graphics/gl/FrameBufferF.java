 ...
 */
public class FrameBufferF extends FrameBuffer {
    ...
    public FrameBufferF(int width, int height) {
        this(Format.rgba8888, width, height, false, false);
    }

    public FrameBufferF(Format format, int width, int height) {
        this(format, width, height, false, false);
    }

    public FrameBufferF(Format format, int width, int height, boolean hasDepth) {
        this(format, width, height, hasDepth, false);
    }

    public FrameBufferF(int width, int height, boolean hasDepth) {
        this(Format.rgba8888, width, height, hasDepth, false);
    }

    public FrameBufferF(Format format, int width, int height, boolean hasDepth, boolean hasStencil) {
