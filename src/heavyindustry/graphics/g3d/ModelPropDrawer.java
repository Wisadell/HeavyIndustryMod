...
public class ModelPropDrawer implements Disposable {
    ...
    public static final Boolf2<VertexAttribute, VertexAttribute> attribEq = (a, b) -> a.components == b.components && a.normalized == b.normalized && a.type == b.type && a.alias.equals(b.alias) && a.size == b.size;
