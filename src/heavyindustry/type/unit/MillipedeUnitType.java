...
public class MillipedeUnitType extends UnitType {
    //Millipede rendering
    protected final static Rect viewport = new Rect(), viewport2 = new Rect();
    protected final static int chunks = 4;
    ...
    public static class MillipedeDecal {
        protected final static Vec2 v1 = new Vec2();
