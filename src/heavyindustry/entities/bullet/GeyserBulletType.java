...
public class GeyserBulletType extends BulletType {
    ...
    public Effect spawnEffect = HIFx.giantSplash;
    public Effect hotSmokeEffect = HIFx.hotSteam;
    public Effect coldSmokeEffect = HIFx.iceSheet;
    ...
    public float getRad(Bullet b) {
        return (radiusInc + radius) * Mathf.clamp(15f * b.fout());
    }
    ...
    public void effects(Bullet b, Liquid l) {
        if (Mathf.chance(smokeChance)) {
            if (l.temperature < 0.32f) coldSmokeEffect.at(b.x, b.y, l.color);
                ...
                hotSmokeEffect.at(b.x, b.y, l.temperature > 1.4f ? Pal.gray : l.temperature > 0.7f ? Color.lightGray : Color.white);
        }
